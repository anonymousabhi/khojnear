...
ALTER TABLE
    "services" ADD CONSTRAINT "services_service_type_id_foreign" FOREIGN KEY("service_type_id") REFERENCES "service_type"("id");
ALTER TABLE
...
ALTER TABLE
    "service_provider" ADD CONSTRAINT "service_provider_city_id_foreign" FOREIGN KEY("city_id") REFERENCES "city"("id");